...
El código fuente de este documento está disponible en [https://github.com/biodatacr/mapas-psa-biodiversidad-2024/blob/main/src/data/depuracion-lista-especies-animales.qmd](https://github.com/biodatacr/mapas-psa-biodiversidad-2024/blob/main/src/data/depuracion-lista-especies-animales.qmd).
...
```{r}
#| label: visualizacion-valores-cites-1
#| warning: false
#| message: false
#| code-fold: true
...
```{r}
#| label: visualizacion-valores-cites-2
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para la visualización de valores de la columna de categorías de CITES"
...
```{r}
#| label: visualizacion-valores-iucn-1
#| warning: false
#| message: false
#| code-fold: true
...
```{r}
#| label: visualizacion-valores-sinac-1
#| warning: false
#| message: false
#| code-fold: true
...
```{r}
#| label: visualizacion-valores-sinac-2
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para la visualización de valores de la columna de categorías de SINAC"
...
```{r}
#| label: visualizacion-valores-endemismo-1
#| warning: false
#| message: false
#| code-fold: true
...
Se realizaron aquí correcciones que no se realizaron anteriormente.

```{r}
#| label: correcciones-finales
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para las correcciones finales"
...
lista_especies_03_final <- 
  ...
  mutate(
    category_cites = case_when(
      canonicalName == "Atelopus chirripoensis" ~ NA,
      TRUE ~ category_cites
    ),
    category_iucn = case_when(
      canonicalName == "Atelopus chirripoensis" ~ "DATA_DEFICIENT",
      TRUE ~ category_iucn
    ),
    category_sinac = case_when(
      canonicalName == "Atelopus chirripoensis" ~ "PELIGRO DE EXTINCIÓN ",
      TRUE ~ category_sinac
    ),
    category_endemism = case_when(
      canonicalName == "Atelopus chirripoensis" ~ "Endémica",
      TRUE ~ category_endemism
    )
  )
...
lista_especies_03_final <- 
  ...
  mutate(
    category_cites = case_when(
      canonicalName == "Atelopus senex" ~ NA,
      TRUE ~ category_cites
    ),
    category_iucn = case_when(
      canonicalName == "Atelopus senex" ~ "EXTINCT",
      TRUE ~ category_iucn
    ),
    category_sinac = case_when(
      canonicalName == "Atelopus senex" ~ "PELIGRO DE EXTINCIÓN ",
      TRUE ~ category_sinac
    ),
    category_endemism = case_when(
      canonicalName == "Atelopus senex" ~ "Endémica",
      TRUE ~ category_endemism
    )
  )
...
lista_especies_03_final <- 
  ...
  mutate(
    category_cites = case_when(
      canonicalName == "Incilius chompipe" ~ NA,
      TRUE ~ category_cites
    ),
    category_iucn = case_when(
      canonicalName == "Incilius chompipe" ~ "ENDANGERED",
      TRUE ~ category_iucn
    ),
    category_sinac = case_when(
      canonicalName == "Incilius chompipe" ~ "POBLACIÓN REDUCIDA O AMENAZADA",
      TRUE ~ category_sinac
    ),
    category_endemism = case_when(
      canonicalName == "Incilius chompipe" ~ "Endémica",
      TRUE ~ category_endemism
    )
  )

# Esto es para un caso en el que hay dos sinónimos de la misma especie, pero sin el nombre aceptado
# Se elimina uno cualquiera
# ESTE CASO, EN GENERAL, DEBE CONSIDERARSE DE MANERA GENERAL
lista_especies_03_final <- 
  lista_especies_03_final |>
  filter(canonicalName != "Cantorchilus elutus")

# Se eliminan registros con speciesKey = NA
lista_especies_03_final <- 
  lista_especies_03_final |>
  filter(!is.na(speciesKey))
```

**Valores en la columna de categorías de CITES (para verificar las correcciones)**

```{r}
#| label: visualizacion-valores-cites-3
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para la visualización de valores de la columna de categorías de CITES"
...
# Valores de la columna
unique(lista_especies_03_final$category_cites)
```

**Valores en la columna de categorías de IUCN (para verificar las correcciones)**

```{r}
#| label: visualizacion-valores-iucn-3
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para la visualización de valores de la columna de categorías de IUCN"
...
# Valores de la columna
unique(lista_especies_03_final$category_iucn)
```

**Valores en la columna de categorías de SINAC (para verificar las correcciones)**

```{r}
#| label: visualizacion-valores-sinac-3
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para la visualización de valores de la columna de categorías de SINAC"
...
# Valores de la columna
unique(lista_especies_03_final$category_sinac)
```

**Valores en la columna de categorías de Endemismo (para verificar la correcciones)**

```{r}
#| label: visualizacion-valores-endemismo-3
#| warning: false
#| message: false
#| code-fold: true
#| code-summary: "Código para la visualización de valores de la columna de categorías de Endemismo"
...
# Valores de la columna
unique(lista_especies_03_final$category_endemism)
```
