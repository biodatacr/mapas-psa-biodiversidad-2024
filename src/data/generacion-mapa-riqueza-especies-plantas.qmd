...
colores_riqueza_especies <-
  colorNumeric(
    palette = "Reds",
    domain = riqueza_especies_poligonos$especies,
...
leaflet() |>
  ...
  addPolygons(
    ...
    fillColor = ~ colores_riqueza_especies(riqueza_especies_poligonos$especies),
    fillOpacity = 0.8,
    color = "black",
    stroke = TRUE,
    weight = 1.0,
    popup = paste(
      ...
      paste("<strong>Riqueza de especies:</strong>", riqueza_especies_poligonos$especies),
      sep = '<br/>'
    ),
  ...
  addLegend(
    ...
    values = riqueza_especies_poligonos$especies,
    group = "Riqueza de especies",
