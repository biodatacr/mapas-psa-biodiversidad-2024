...
lista_especies_01_depurada_basica_04_final <-
  lista_especies_01_depurada_basica_03_espacios_corregidos
...
`r nrow(lista_especies_01_depurada_basica_04_final)`
:::
...
lista_especies_02_depurada_taxonomica_00_inicial <- 
  name_backbone_checklist(
    name_data = lista_especies_01_depurada_basica_04_final, 
    kingdom = REINO,
    strict = TRUE
)
```
...
lista_especies_01_depurada_basica_04_final_01_ortografia_corregida <- 
  lista_especies_01_depurada_basica_04_final |>
  mutate(
    name = case_when(
...
# Borrado de registros con nombres de especies duplicados
lista_especies_01_depurada_basica_04_final_02_duplicados_borrados <-
  lista_especies_01_depurada_basica_04_final_01_ortografia_corregida |>
...
::: {.callout-note title="Cantidad de registros en la lista depurada de especies (después de borrar los duplicados)"}
`r nrow(lista_especies_01_depurada_basica_04_final_02_duplicados_borrados)`
:::
...
lista_especies_02_depurada_taxonomica_01_ortografia_corregida <- 
  name_backbone_checklist(
    name_data = lista_especies_01_depurada_basica_04_final_02_duplicados_borrados, 
    kingdom = REINO,
    strict = TRUE
)
```
...
lista_especies_01_depurada_basica_04_final_03_sinonimia_corregida <-
  lista_especies_01_depurada_basica_04_final_02_duplicados_borrados
...
lista_especies_02_depurada_taxonomica_02_sinonimia_corregida <- 
  name_backbone_checklist(
    name_data = lista_especies_01_depurada_basica_04_final_03_sinonimia_corregida, 
    kingdom = REINO,
    strict = TRUE
)
```
